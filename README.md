...
The script can read input from */etc/backup.conf*. Alternative path can also be specified: <code>star.sh -i 0 -C /path/backup.conf</code> or <code>star-gui.sh /path/backup.conf</code>.
