...
<sub>*Fedora 19 tar: xattrs patch bug(?), decompressed system can't login. Downgrading to 1.26-12.fc18 fixes the problem. 
 Libarchive Tar and Transfer Mode works.</sub>
