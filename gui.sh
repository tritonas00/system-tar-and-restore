...
efibootmgr dosfstools systemd"><label>"<span color='"'brown'"'>Make a backup archive of this system.</span>"</label></text>
                                ...
                                <hbox>
                                        ...
                                        '"`source /tmp/wr_functions; set_default_pass`"'
                                        </entry>
                                </hbox>
                                ...
                                <hbox>
                                        ...
                                        <comboboxentry space-expand="true" space-fill="true" tooltip-text="Set extra tar options. See tar --help for more info. If you want spaces in names replace them with //">
                                                ...
                                                '"`source /tmp/wr_functions; set_default_opts`"'
                                ...
                                '"`source /tmp/wr_functions; set_default_multi`"'
       ...
       configurations."><label>"<span color='"'brown'"'>Restore a backup archive or transfer this system in user defined partitions.</span>"</label></text>
                                ...
                                <vbox>
                                        <frame Target partitions:>
		                                        ...
		                                        <comboboxtext space-expand="true" space-fill="true" tooltip-text="Select target root partition">
	                                                        ...
	                                                        <input>source /tmp/wr_functions; echo "$BR_PARTS" | hide_used_parts</input>
                                        ...
                                        <frame Bootloader:>
                                                <hbox>
                                                        ...
                                                        <comboboxtext space-expand="true" space-fill="true" tooltip-text="Select target disk for bootloader" sensitive="false">
	                                                        ...
	                                                        <input>source /tmp/wr_functions; scan_disks</input>
	                                                </comboboxtext>
                ...
                <hbox homogeneous="true" space-expand="false" space-fill="false">
                        <button tooltip-text="Run">
                                ...
                                <action>source /tmp/wr_functions; set_args && run_main &</action>
			...
			<input>source /tmp/wr_functions; status_bar</input>
		</statusbar>
        </vbox>
</window>
'
